...
const Booking = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    date: "",
    time: "",
    professional: "Michael Rodriguez",
    service: "Plumbing",
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-white rounded-[2.5rem] overflow-hidden border border-gray-100 shadow-sm">
              <div className="relative h-64">
                <img src="https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=800&q=80" className="w-full h-full object-cover" alt="Service" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                <div className="absolute bottom-6 left-6 text-white">
                  <span className="bg-[#4EC9B0] text-white px-3 py-1 rounded-lg text-xs font-bold uppercase tracking-wider">Plumbing</span>
                  <h2 className="text-3xl font-extrabold mt-2">Expert Repair</h2>
                </div>
              </div>
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex items-center gap-1 bg-[#F0FDF4] px-3 py-1.5 rounded-xl text-[#4EC9B0] font-bold text-sm"><Star size={16} fill="currentColor" /> 4.8</div>
          ...
          <div className="lg:col-span-7 bg-white p-8 md:p-12 rounded-[2.5rem] border border-gray-100 shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div>
                ...
                <select name="professional" onChange={handleChange} className="w-full bg-gray-50 border-none rounded-2xl p-4 focus:ring-2 focus:ring-[#4EC9B0]">
                  <option value="Michael Rodriguez">Michael Rodriguez (Master Plumber)</option>
                  <option value="Lisa Anderson">Lisa Anderson (Senior Plumber)</option>
                </select>
              </div>
